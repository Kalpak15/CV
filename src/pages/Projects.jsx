...
//   // Generate particles with containment
//   useEffect(() => {
...
//       // Create particles - limited number for better performance
//       for (let i = 0; i < 30; i++) {
//         const particle = document.createElement('div');
//         particle.className = 'particle';
        
//         // Contained random position
//         const x = Math.random() * 90 + 5; // Keep away from edges
//         const y = Math.random() * 90 + 5; // Keep away from edges
...
//         // Animation with contained movement
...
//     // Only create particles if section is visible
...
//     // Regenerate particles on resize, but with debounce
//     let resizeTimer;
//     const handleResize = () => {
...
//   // Initial animations and mouse tracking for custom cursor - now contained
//   useEffect(() => {
//     // Reveal animation for the section only when visible
...
//     // Track mouse position for the custom cursor only within the section
...
//   // Limited parallax effect on title - less extreme movement
//   useEffect(() => {
//     const handleMouseMove = (e) => {
//       if (!titleRef.current || !sectionRef.current) return;
      
//       // Only apply effect when mouse is in the section
...
//       // More subtle movement (reduced from 15px to 8px)
...
//   // Better controlled parallax effect on scroll
//   useEffect(() => {
//     const handleScroll = () => {
...
//       cardsRef.current.forEach((card, index) => {
//         if (card) {
//           // Reduced effect (from 0.05 to 0.02)
//           const speed = 0.02 + (index * 0.005);
//           const yPos = scrollPosition * speed;
//           // Limit the maximum translation
//           const maxTranslation = 30;
//           const translation = Math.min(yPos, maxTranslation);
...
//       ref={sectionRef}
//     >
//       {/* Custom cursor - now contained within section */}
//       {cursorVisible && (
//         <div 
...
//       {/* Floating particles - contained within section */}
//       <div ref={particlesRef} className="absolute inset-0 overflow-hidden pointer-events-none"></div>
      
//       {/* Animated background elements - more contained */}
//       <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
//         {/* Reduced size and opacity of background elements */}
//         <div className="animate-blurFloat absolute top-1/4 -left-10 w-80 h-80 bg-purple-700 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
//         <div className="animate-blurFloat animation-delay-2000 absolute -bottom-24 -right-10 w-80 h-80 bg-blue-700 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
//         <div className="animate-blurFloat animation-delay-4000 absolute bottom-1/3 left-1/4 w-80 h-80 bg-pink-700 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
...
//         <div 
//           ref={titleRef}
//           className={`text-5xl font-bold mb-20 text-center relative z-10 transition-all duration-700 ease-out ${loaded ? 'opacity-100' : 'opacity-0 translate-y-4'}`}
//           style={{ transitionDelay: '300ms' }}
//         >
//           <span className="bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 text-transparent bg-clip-text">
//             Personal Projects
//           </span>
//           <div className="w-24 h-1 bg-gradient-to-r from-purple-500 to-blue-500 mx-auto mt-4 animate-line-grow"></div>
//         </div>
...
//             <div 
//               key={project.id}
//               className={`relative group cursor-pointer transition-all duration-700 ease-out ${loaded ? 'opacity-100' : 'opacity-0 translate-y-4'}`}
//               style={{
...
//               <div className="relative h-80 rounded-xl overflow-hidden bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 shadow-xl shadow-purple-900/10 transform transition-all duration-500 hover:-translate-y-2">
//                 <div className="h-48 overflow-hidden">
//                   <img 
//                     src={project.image} 
//                     alt={project.title} 
...
//             <button 
//               onClick={toggleProjectVisibility}
//               className={`inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-medium rounded-full relative overflow-hidden group transition-all duration-700 ease-out ${loaded ? 'opacity-100' : 'opacity-0'}`}
...
//               </span>
//               <span className="absolute inset-0 bg-gradient-to-r from-blue-600 to-purple-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
//               <span className="absolute -inset-1 rounded-full animate-pulse-ring opacity-0 group-hover:opacity-50"></span>
//             </button>
//           )}
//         </div>
//       </div>
...
//           border-radius: 50%;
//           opacity: 0.2;
//           /* Modified animation for more contained behavior */
